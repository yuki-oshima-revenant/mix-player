    ...
    return (
        <div>
            ...
            <div className="bg-black text-white">
                ...
                {/* <h1>mix list</h1> */}
                <div style={{ height: `calc(100vh - 32px)`, minHeight: `calc(${data.length * (isMobile ? 160 : 320)}px + 32px + 32px)` }} className="pt-12 w-screen">
                    {
                        data.map((mix, mixIndex) => (
                            <div key={mix.title} className="flex h-[160px] lg:h-[320px] cursor-pointer group" onClick={() => { router.push(`/mix/${mixIndex + 1}`) }}>
                                ...
                                <div className='absolute overflow-hidden'>
                                    <div className='flex w-screen h-[160px] lg:h-[320px]'>
